...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Medien = new QWidget();
        Medien->setObjectName(QString::fromUtf8("Medien"));
        ...
        author_input->setObjectName(QString::fromUtf8("author_input"));
        ...
        saveBox_media->setObjectName(QString::fromUtf8("saveBox_media"));
        saveBox_media->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);

        formLayout_2->setWidget(1, QFormLayout::FieldRole, saveBox_media);

        columnView = new QColumnView(add_media);
        columnView->setObjectName(QString::fromUtf8("columnView"));

        formLayout_2->setWidget(0, QFormLayout::FieldRole, columnView);
        ...
        search_media->setObjectName(QString::fromUtf8("search_media"));
        ...
        title_input_search->setObjectName(QString::fromUtf8("title_input_search"));
        ...
        author_input_search->setObjectName(QString::fromUtf8("author_input_search"));
        ...
        searchBox_media->setObjectName(QString::fromUtf8("searchBox_media"));
        ...
        all_media->setObjectName(QString::fromUtf8("all_media"));
        verticalLayout = new QVBoxLayout(all_media);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        media_table = new QTableWidget(all_media);
        media_table->setObjectName(QString::fromUtf8("media_table"));
        ...
        Personen->setObjectName(QString::fromUtf8("Personen"));
        ...
        search_person_btn->setObjectName(QString::fromUtf8("search_person_btn"));

        verticalLayout_9->addWidget(search_person_btn);

        add_person = new QWidget(Personen);
        add_person->setObjectName(QString::fromUtf8("add_person"));
        verticalLayout_6 = new QVBoxLayout(add_person);
        verticalLayout_6->setObjectName(QString::fromUtf8("verticalLayout_6"));
        warning_person = new QLabel(add_person);
        warning_person->setObjectName(QString::fromUtf8("warning_person"));
        ...
        birthday_input->setObjectName(QString::fromUtf8("birthday_input"));
        ...
        gender_input_w->setObjectName(QString::fromUtf8("gender_input_w"));

        horizontalLayout_2->addWidget(gender_input_w);

        gender_input_m = new QRadioButton(add_person);
        gender_input_m->setObjectName(QString::fromUtf8("gender_input_m"));

        horizontalLayout_2->addWidget(gender_input_m);

        gender_input_d = new QRadioButton(add_person);
        gender_input_d->setObjectName(QString::fromUtf8("gender_input_d"));
        ...
        saveBox_person->setObjectName(QString::fromUtf8("saveBox_person"));
        ...
        all_person->setObjectName(QString::fromUtf8("all_person"));
        verticalLayout_5 = new QVBoxLayout(all_person);
        verticalLayout_5->setObjectName(QString::fromUtf8("verticalLayout_5"));
        search_person = new QWidget(all_person);
        search_person->setObjectName(QString::fromUtf8("search_person"));
        ...
        firstname_input_search->setObjectName(QString::fromUtf8("firstname_input_search"));
        ...
        surname_input_search->setObjectName(QString::fromUtf8("surname_input_search"));
        ...
        searchBox_person->setObjectName(QString::fromUtf8("searchBox_person"));
        ...
        person_table->setObjectName(QString::fromUtf8("person_table"));
